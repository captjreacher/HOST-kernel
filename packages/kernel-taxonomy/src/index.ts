...
const objectTypes: readonly TaxonomyObjectEntry[] = [
  ...
  { kind: 'objectType', code: 'K2', value: 'relationship', label: 'Relationship', description: 'A directed or undirected link between two knowledge objects.' },
  ...
  { kind: 'objectType', code: 'K5', value: 'signal', label: 'Signal', description: 'A measurable indication that something changed or may change.' },
  { kind: 'objectType', code: 'K6', value: 'observation', label: 'Observation', description: 'A human or machine note about what was seen.' },
  { kind: 'objectType', code: 'K7', value: 'evidence', label: 'Evidence', description: 'A verifiable record supporting a claim or observation.' },
...
const identifierPrefixes: readonly TaxonomyIdentifierPrefixEntry[] = [
  ...
  { kind: 'identifierPrefix', code: 'RLT', value: 'RLT', label: 'Relationship', description: 'Canonical identifier prefix for relationships.' },
  { kind: 'identifierPrefix', code: 'SIG', value: 'SIG', label: 'Signal', description: 'Canonical identifier prefix for signals.' },
  { kind: 'identifierPrefix', code: 'OBS', value: 'OBS', label: 'Observation', description: 'Canonical identifier prefix for observations.' },
  { kind: 'identifierPrefix', code: 'EVD', value: 'EVD', label: 'Evidence', description: 'Canonical identifier prefix for evidence.' },
